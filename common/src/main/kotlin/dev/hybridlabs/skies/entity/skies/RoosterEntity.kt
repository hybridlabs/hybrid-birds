...
class RoosterEntity(entityType: EntityType<out RoosterEntity>, world: Level) :
    ...
    private fun morningCall() {
        ...
        if (timeOfDay in 0..5 && !hasCalled) {
            this.playSound(HSSoundEvents.ROOSTER_CALL.get(), 1.0F, 1.0F)
    ...
    private fun applySpeedEffectToNearbyPlayers() {
        ...
        val speedEffect = MobEffectInstance(HSMobEffects.ROOSTERS_CALLING.asHolder(), 6000, 0, true, false)
    ...
    override fun getAmbientSound(): SoundEvent {
        return HSSoundEvents.ROOSTER_AMBIENT.get()
    }

    override fun getHurtSound(source: DamageSource): SoundEvent {
        return HSSoundEvents.ROOSTER_HURT.get()
    }

    override fun getDeathSound(): SoundEvent {
        return HSSoundEvents.ROOSTER_DIE.get()
    }
