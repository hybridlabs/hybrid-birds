...
class AlbatrossEntity(type: EntityType<out AlbatrossEntity>, world: Level) :
    ...
    override fun getBreedOffspring(serverLevel: ServerLevel, ageableMob: AgeableMob): AlbatrossEntity? {
        return HSEntityTypes.ALBATROSS.get().create(serverLevel)
    }

    override fun getAmbientSound(): SoundEvent {
        return HSSoundEvents.ALBATROSS_AMBIENT.get()
    }

    override fun getHurtSound(source: DamageSource): SoundEvent {
        return HSSoundEvents.ALBATROSS_HURT.get()
    }

    override fun getDeathSound(): SoundEvent {
        return HSSoundEvents.ALBATROSS_DIE.get()
    }
