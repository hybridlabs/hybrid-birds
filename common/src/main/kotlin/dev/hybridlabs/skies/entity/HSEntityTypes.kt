...
import dev.hybridlabs.skies.entity.bird.*
...
object HSEntityTypes {
    ...
    val PUFFIN = registerAquaticBird(
        "puffin",
        ::PuffinEntity,
        EntityDimensions.fixed(0.5f, 0.6f),
        PuffinEntity::createMobAttributes
    )
    ...
    val ALBATROSS = registerAquaticBird(
        "albatross",
        ::AlbatrossEntity,
        EntityDimensions.fixed(0.6f, 0.75f),
        AlbatrossEntity::createMobAttributes
    )
    ...
    private fun <T : LivingEntity> registerCustomSpawnGroup(
        ...
        dimensions: EntityDimensions,
        attributeContainer: Callable<AttributeSupplier.Builder>,
        hybridBirdsSpawnGroup: MobCategory,
        trackingRange: Int = 5,
