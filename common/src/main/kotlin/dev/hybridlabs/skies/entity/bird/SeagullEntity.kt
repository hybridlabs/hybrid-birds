...
class SeagullEntity(type: EntityType<out SeagullEntity>, world: Level) :
    ...
    override fun getBreedOffspring(serverLevel: ServerLevel, ageableMob: AgeableMob): SeagullEntity? {
        return HSEntityTypes.SEAGULL.get().create(serverLevel)
    }

    override fun getAmbientSound(): SoundEvent {
        return HSSoundEvents.SEAGULL_AMBIENT.get()
    }

    override fun getHurtSound(source: DamageSource): SoundEvent {
        return HSSoundEvents.SEAGULL_HURT.get()
    }

    override fun getDeathSound(): SoundEvent {
        return HSSoundEvents.SEAGULL_DIE.get()
    }
