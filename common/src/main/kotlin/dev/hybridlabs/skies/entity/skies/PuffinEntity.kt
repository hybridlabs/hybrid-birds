...
class PuffinEntity(type: EntityType<out PuffinEntity>, world: Level) :
    ...
    override fun getBreedOffspring(serverLevel: ServerLevel, ageableMob: AgeableMob): PuffinEntity? {
        return HSEntityTypes.PUFFIN.get().create(serverLevel)
    }

    override fun getAmbientSound(): SoundEvent {
        return HSSoundEvents.PUFFIN_AMBIENT.get()
    }

    override fun getHurtSound(source: DamageSource): SoundEvent {
        return HSSoundEvents.PUFFIN_HURT.get()
    }

    override fun getDeathSound(): SoundEvent {
        return HSSoundEvents.PUFFIN_DIE.get()
    }
