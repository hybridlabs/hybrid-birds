...
class PelicanEntity(type: EntityType<out PelicanEntity>, world: Level) :
    ...
    override fun getBreedOffspring(serverLevel: ServerLevel, ageableMob: AgeableMob): PelicanEntity? {
        return HSEntityTypes.PELICAN.get().create(serverLevel)
    }

    override fun getAmbientSound(): SoundEvent {
        return HSSoundEvents.PELICAN_AMBIENT.get()
    }

    override fun getHurtSound(source: DamageSource): SoundEvent {
        return HSSoundEvents.PELICAN_HURT.get()
    }

    override fun getDeathSound(): SoundEvent {
        return HSSoundEvents.PELICAN_DIE.get()
    }
