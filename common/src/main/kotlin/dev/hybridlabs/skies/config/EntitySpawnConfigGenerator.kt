...
class EntitySpawnConfigGenerator {
    ...
    fun finalizeSpawn() {
        ...
        //addLandBird(HSEntityTypes.HUMMINGBIRD.get(), listOf(HSBiomeTags.HUMMINGBIRD_SPAWN_BIOMES), 3, 1, 3)
        //addLandBird(HSEntityTypes.OSTRICH.get(), listOf(BiomeTags.IS_SAVANNA), 2, 1, 3)
        //addLandBird(HSEntityTypes.KIWI.get(), listOf(HSBiomeTags.KIWI_SPAWN_BIOMES), 2, 1, 1)
        //addLandBird(HSEntityTypes.JAY.get(), listOf(BiomeTags.IS_FOREST, BiomeTags.IS_TAIGA), 3, 1, 3)
        addWaterBird(HSEntityTypes.PUFFIN.get(), listOf(HSBiomeTags.PUFFIN_SPAWN_BIOMES), 5, 2, 5)
        addWaterBird(HSEntityTypes.SEAGULL.get(), listOf(HSBiomeTags.SEAGULL_SPAWN_BIOMES), 5, 2, 5)
        addWaterBird(HSEntityTypes.ALBATROSS.get(), listOf(HSBiomeTags.ALBATROSS_SPAWN_BIOMES), 3, 1, 3)
        addWaterBird(HSEntityTypes.PELICAN.get(), listOf(HSBiomeTags.PELICAN_SPAWN_BIOMES), 3, 1, 2)
        //addWaterBird(HSEntityTypes.FLAMINGO.get(), listOf(HSBiomeTags.FLAMINGO_SPAWN_BIOMES), 2, 1, 3)
