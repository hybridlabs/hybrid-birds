...
class EntitySpawnConfigGenerator {
    ...
    fun finalizeSpawn() {
        ...
        addWaterBird(HBEntityTypes.PUFFIN.get(), listOf(HBBiomeTags.PUFFIN_SPAWN_BIOMES), 5, 2, 5)
        addWaterBird(HBEntityTypes.SEAGULL.get(), listOf(HBBiomeTags.SEAGULL_SPAWN_BIOMES), 5, 2, 5)
        addWaterBird(HBEntityTypes.ALBATROSS.get(), listOf(HBBiomeTags.ALBATROSS_SPAWN_BIOMES), 3, 1, 3)
        addWaterBird(HBEntityTypes.PELICAN.get(), listOf(HBBiomeTags.PELICAN_SPAWN_BIOMES), 3, 1, 2)
