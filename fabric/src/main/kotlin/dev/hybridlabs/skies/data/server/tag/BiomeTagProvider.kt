...
class BiomeTagProvider(output: FabricDataOutput, registriesFuture: CompletableFuture<HolderLookup.Provider>) :
    ...
    override fun addTags(arg: HolderLookup.Provider) {
        ...
        getOrCreateTagBuilder(HSBiomeTags.PUFFIN_SPAWN_BIOMES)
        ...
        getOrCreateTagBuilder(HSBiomeTags.SEAGULL_SPAWN_BIOMES)
        ...
        getOrCreateTagBuilder(HSBiomeTags.DUCK_SPAWN_BIOMES)
            .add(Biomes.RIVER)
            .add(Biomes.SWAMP)
        ...
        getOrCreateTagBuilder(HSBiomeTags.GOOSE_SPAWN_BIOMES)
            .add(Biomes.RIVER)
            .add(Biomes.TAIGA)
            .addOptional(ResourceLocation.fromNamespaceAndPath("hybrid-aquatic", "tropical_river"))
            .addOptional(ResourceLocation.fromNamespaceAndPath("hybrid-aquatic", "placer_river"))
        ...
        getOrCreateTagBuilder(HSBiomeTags.SWAN_SPAWN_BIOMES)
            .add(Biomes.RIVER)
            .addOptional(ResourceLocation.fromNamespaceAndPath("hybrid-aquatic", "cold_river"))
            .addOptional(ResourceLocation.fromNamespaceAndPath("regions_unexplored", "cold_river"))
            .addOptional(ResourceLocation.fromNamespaceAndPath("riverredux", "gravelly_river"))

        getOrCreateTagBuilder(HSBiomeTags.FLAMINGO_SPAWN_BIOMES)
            .addOptional(ResourceLocation.fromNamespaceAndPath("hybrid-aquatic", "seasonal_river"))
            .forceAddTag(BiomeTags.IS_SAVANNA)

        getOrCreateTagBuilder(HSBiomeTags.ROOSTER_SPAWN_BIOMES)
            .add(Biomes.PLAINS)
        ...
        getOrCreateTagBuilder(HSBiomeTags.TURKEY_SPAWN_BIOMES)
        ...
        getOrCreateTagBuilder(HSBiomeTags.KIWI_SPAWN_BIOMES)
            .add(Biomes.OLD_GROWTH_PINE_TAIGA)
            .add(Biomes.OLD_GROWTH_SPRUCE_TAIGA)
            .add(Biomes.DARK_FOREST)

        getOrCreateTagBuilder(HSBiomeTags.HUMMINGBIRD_SPAWN_BIOMES)
            .add(Biomes.FLOWER_FOREST)
            .add(Biomes.SUNFLOWER_PLAINS)
    }
}